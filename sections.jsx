...
const MenuHighlights = () => {
  ...
  const items = {
    ...
    bruschetta: [
      ...
      { name: 'Брускетта с подкопченной индейкой', price: 170, weight: '40 г', desc: 'Чиабатта, томаты черри, лист салата.', photo: 'images/Брускетта с подкопченой индейкой.jpeg' },
      ...
      { name: 'Брускетта овощи гриль с мягким сыром', price: 170, weight: '40 г', desc: 'Чиабатта, мягкий сыр, печёные овощи, зелень.', photo: 'images/Брусскетта овощи гриль с мягким сыром.jpeg' },
    ],
    hot: [
