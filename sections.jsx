...
const FAQ = () => {
  ...
  const items = [
    { q: 'За сколько дней нужно бронировать?', a: 'Гастробоксы — от 3 дней. Фуршеты и кофе-брейки — от 7 дней. Банкеты и свадьбы — от 2–3 недель. В пиковые даты (14 февраля, 8 марта, новогодние) — раньше.' },
    { q: 'Привозите ли посуду и сервировку?', a: 'Да. В стоимость уже входят тарелки, приборы, бокалы, текстиль и расстановка. Стилизованная сервировка (флористика, ассессуары) — опция, обсуждаем отдельно.' },
    { q: 'Что с остатками еды?', a: 'Невскрытые блюда собираем в гастроконтейнеры и оставляем заказчику. Вскрытое — по СанПиН утилизируем.' },
    { q: 'Можно ли безлактозное / халяль / веган?', a: 'Да. Отмечаете при брифе — шеф адаптирует меню. У нас есть сертифицированные халяль-поставщики мяса.' },
    { q: 'Как платим?', a: 'Для частных лиц — 50% предоплата, остаток в день события. Для юрлиц — по счёту, постоплата возможна по договору.' },
    { q: 'Работаете за пределами Казани?', a: 'Да, выезжаем по РТ и соседним регионам. Логистику считаем индивидуально.' },
  ];
