...
const MenuHighlights = ({ label = '03 · Меню' } = {}) => {
  ...
  const items = {
    ...
    'mini-salad': [
      { name: 'Мини-салат «Греческий»', price: 200, weight: '120 г', desc: 'Томаты, огурцы, перец болгарский, сыр фета, маслины, оливки.', photo: ASSET('/images/Мини салат Греческий.jpeg'), step: 5 },
      { name: 'Мини-салат «Цезарь» с курицей', price: 255, weight: '100 г', desc: 'Листья салата, томаты черри, сухарики, соус, сыр пармезан, копчёная курица.', photo: ASSET('/images/Мини салат цезарь.jpeg'), step: 5 },
      { name: 'Мини-салат «Цезарь» с тигровыми креветками', price: 350, weight: '120 г', desc: 'Листья салата, томаты черри, сухарики, соус, сыр пармезан, креветки.', photo: ASSET('/images/Мини салат цезарь с креветками.jpeg'), step: 5 },
      { name: 'Мини-салат с тунцом', price: 400, weight: '110 г', desc: 'Тунец свежий, микс салата, томаты черри, перепелиные яйца, картофель бэби, лаймовая заправка.', photo: ASSET('/images/Мини салат с тунцом.jpeg'), step: 5 },
      { name: 'Мини-салат тёплый с говядиной', price: 310, weight: '110 г', desc: 'Говядина в сливочном соусе, свежие и маринованные овощи.', photo: ASSET('/images/Мини теплый салат с говядиной.jpeg'), step: 5 },
      { name: 'Мини-салат с ростбифом из телятины', price: 310, weight: '100 г', desc: 'Томаты черри, стебель сельдерея, микс салата, печёный перец, пармезан, ростбиф.', photo: ASSET('/images/Мини салат с ростбифом из телятины.jpeg'), step: 5 },
      { name: 'Сезонные фрукты и ягоды в стаканчиках', price: 350, weight: '180 г', desc: 'Свежие ягоды и сезонные фрукты.', photo: ASSET('/images/Сезонные фрукты и ягоды.jpeg'), step: 5 },
